...
<html>
    ...
    <body>
        ...
        <div id="edit-resident" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.resident}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.resident}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.resident}" method="PUT">
                <g:hiddenField name="version" value="${this.resident?.version}" />
                <fieldset class="form">
                    <f:all bean="resident"/>
                </fieldset>
