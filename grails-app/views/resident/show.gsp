...
<html>
    ...
    <body>
        ...
        <div id="show-resident" class="content scaffold-show" role="main">
            ...
            <f:display bean="resident" />
            <g:form resource="${this.resident}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.resident}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
