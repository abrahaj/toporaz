...
<html>
    ...
    <body>
        ...
        <div id="edit-personRelation" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.personRelation}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.personRelation}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.personRelation}" method="PUT">
                <g:hiddenField name="version" value="${this.personRelation?.version}" />
                <fieldset class="form">
                    <f:all bean="personRelation"/>
                </fieldset>
