...
<html>
    ...
    <body>
        ...
        <div id="show-personRelation" class="content scaffold-show" role="main">
            ...
            <f:display bean="personRelation" />
            <g:form resource="${this.personRelation}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.personRelation}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
